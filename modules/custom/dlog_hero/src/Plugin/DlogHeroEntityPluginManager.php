 ...
 */
class DlogHeroEntityPluginManager extends DefaultPluginManager {
  ...
  $subdir = "Plugin/DlogHero/Entity";
  $plugin_interface = "Drupal\dlog_hero\Plugin\DlogHero\Entity\DlogHeroEntityPluginInterface";
  $plugin_definition_annotation_name = "Drupal\dlog_hero\Annotation\DlogHeroEntity";
    ...
    $this->alterInfo("dlog_hero_entity");
    $this->setCacheBackend($cacheBackend, "dlog_hero:entity");
