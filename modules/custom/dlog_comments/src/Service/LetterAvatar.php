...
class LetterAvatar implements LetterAvatarInterface {
  ...
  public function fromUserName ($userName) {
    ...
    $userNameMD5Nubmers = filter_var($userNameMD5, FILTER_SANITIZE_NUMBER_INT);
    $strippedNumbers = substr($userNameMD5Nubmers, 0, 16);
    $colorIndex = $strippedNumbers % count($this->colors );
  ...
  public function getTextColor ($color, $textColorDark = '#000000', $textColorLight = '#ffffff') {
    ...
    return $yiq >= 128 ? $textColorDark : $textColorLight;
  }

  /**
   * @inheritdoc
   *
   * @see https://github.com/discourse/discourse/blob/main/lib/letter_avatar.rb#L122
   */
